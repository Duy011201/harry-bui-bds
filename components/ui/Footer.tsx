...
const Footer: React.FC = () => {
  ...
  return (
    <footer id="contact" className="bg-[#050505] text-white pt-24 pb-12 border-t border-white/5 scroll-mt-28">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-20">
          ...
          <div className="space-y-6">
            <a href="#" className="font-serif text-3xl tracking-widest text-gold font-bold block">
              Harry Bùi
            </a>
            <p className="text-gray-500 text-sm font-light leading-relaxed max-w-xs">
              Nâng tầm trải nghiệm làm việc với không gian nghệ thuật, nơi hội tụ của những doanh nghiệp tinh hoa và cộng đồng sáng tạo.
            </p>
          </div>

          {/* Column 2: Contact Info (NEW) */}
          <div>
            <h4 className="text-gold text-xs uppercase tracking-widest mb-6">Thông tin liên hệ</h4>
            <ul className="space-y-5 text-sm text-gray-400 font-light">
              <li className="flex items-start gap-3">
                <MapPin size={18} className="text-gold flex-shrink-0 mt-0.5" />
                <span>
                  Tầng 6, <br />
                  Số 530 Kim Giang, Phường Thanh Liệt, Quận Hoàng Mai, TP Hà Nội
                </span>
              </li>
